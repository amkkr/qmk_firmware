...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_PLUS,                                KC_LCTL, KC_LGUI, LT(1,KC_SPC),     LT(3, KC_ESC), KC_RALT, KC_NO,
        KC_KP_0,          KC_KP_DOT, KC_KP_ENTER
    ),
    ...
    [2] = LAYOUT(
        ...
        KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_PLUS,                                KC_LALT, KC_LGUI, LT(3,KC_SPC),     LT(2, KC_ESC), KC_RALT,KC_NO,
        KC_KP_0,          KC_KP_DOT, KC_KP_ENTER
    ),

    [3] = LAYOUT(
        TG(4), KC_NUM, KC_DEL, KC_KP_SLASH,          KC_F1, KC_F2,   KC_F3,   KC_F4,   KC_F5, KC_F6,                      KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, KC_F12,
        KC_KP_7, KC_KP_8, KC_KP_9, KC_KP_ASTERISK,   KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_NO, KC_NO,                      MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT, KC_NO,  KC_NO,
        KC_KP_4, KC_KP_5, KC_KP_6, KC_KP_MINUS,      KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO,                      MS_WHLL, MS_WHLD, MS_WHLU, MS_WHLR, KC_NO,
        KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_PLUS,                                KC_LCTL, KC_LGUI, LT(2,KC_SPC),   LT(1, KC_ESC), KC_RALT,KC_NO,
        KC_KP_0,          KC_KP_DOT, KC_KP_ENTER
    ),
    ...
    [4] = LAYOUT(
        ...
        KC_F1, KC_F2, KC_F3, KC_F4,                                          KC_SPC, KC_LGUI, KC_SPC,           KC_ESC, KC_RALT, MO(5),
