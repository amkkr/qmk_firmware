...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B,                                  KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH,
                        KC_LCTL, KC_LGUI, LT(2,KC_SPC),           LT(1, KC_ESC), KC_RALT, MO(2)
    ),
    ...
    [1] = LAYOUT(
        ...
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_SPC,                            KC_GRV,  KC_QUOT, KC_COMM, KC_DOT,  KC_SLSH,
                        KC_LCTL, KC_LGUI, LT(2,KC_SPC),           LT(3, KC_ESC), KC_RALT,KC_NO
    ),
    ...
    [2] = LAYOUT(
        ...
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO,   KC_PGUP,                         KC_NO,   KC_NO,   KC_NO, KC_NO,   KC_NO,
                        KC_LCTL, KC_LGUI, LT(3,KC_SPC),           LT(1, KC_ESC), KC_RALT,KC_NO
    ),
